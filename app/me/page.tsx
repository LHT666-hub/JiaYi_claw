...
export default function MePage() {
  ...
  return <PhoneShell showBottomNav><div className="space-y-4 px-4 pb-8 pt-7">
    ...
    {data?.demo ? <div className="rounded-full border border-sage/20 bg-health-soft px-4 py-2 text-center text-xs font-semibold text-sage">只读展示档案 · 不含真实居民信息</div> : null}
