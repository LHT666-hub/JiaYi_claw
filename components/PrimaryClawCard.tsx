  ...
  return (
    <section className="rounded-[30px] bg-gradient-to-br from-navy to-navySoft px-5 py-5 text-white shadow-float">
      <div className="flex items-start justify-between gap-4">
        <div>
          <p className="font-brand text-[1.6rem] font-semibold">问家医 Claw</p>
      ...
      <div className="mt-5 grid gap-3">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-base font-semibold">按住说话</p>
              <p className="text-xs text-navy/58">适合一句话直接问</p>
            </div>
          </div>
          <span className="text-xs font-semibold tracking-[0.14em] text-navy/45">主入口</span>
        </button>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          >
            ...
            <div>
              <p className="text-sm font-semibold">拍照问问</p>
          ...
          >
            ...
            <div>
              <p className="text-sm font-semibold">打字输入</p>
