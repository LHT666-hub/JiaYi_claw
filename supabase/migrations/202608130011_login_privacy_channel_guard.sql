...
begin
  ...
  insert into public.consents (
    ...
    caller_id, caller_id, 'privacy', trim(p_policy_version), true, now_at, null,
  ...
  values (
    ...
    'consents',
    receipt.id,
    jsonb_build_object('scope', 'privacy', 'policy_version', trim(p_policy_version), 'channel', p_channel)
  );
